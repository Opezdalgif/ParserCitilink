...
async function START_SCRIPTS() {
  ...
  await pageSearch.waitForTimeout(1000);
    ...
    await pageSearch.keyboard.sendCharacter(articul);
    await pageSearch.waitForTimeout(1000)
    sleep(100)
   ...
   let newHrefProperties = hrefProperties[0].replace(`/?text=${articul}`, '/properties')
   
    console.log(newHrefProperties)
    console.log(productName[0])
    if(productName[0].indexOf(articul) != -1) {
